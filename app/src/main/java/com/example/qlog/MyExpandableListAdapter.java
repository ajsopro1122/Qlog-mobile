...
public class MyExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private Map<String, List<String>> buildingCollection;
    ...
    public int getChildrenCount(int i) {
        return buildingCollection.get(groupList.get(i)).size();
    }
    ...
    public Object getChild(int i, int i1) {
        return buildingCollection.get(groupList.get(i)).get(i1);
    }
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        String buildingName = getGroup(i).toString();
        if(view == null) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = inflater.inflate(R.layout.group_item, null);

        }
        TextView item = view.findViewById(R.id.building);
